...
console.log(about.nodeType === document.ELEMENT_NODE); // 1 === 1 true
console.log(about.nodeName === 'LI'); // 'LI' === 'LI' true
console.log(about.tagName === 'LI'); // 'LI' === 'LI' true
...
// console.log((about.textContent = '어바웃 페이지')); // setter
