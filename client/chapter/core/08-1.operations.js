...
// spread operator(전개 연산자) or spread syntax(전개 구문)
...
console.log(obj);
// 객체에선 spread operator를 사용하기 위해선 iterator가 필요하다
// console.log(...obj);
...
console.log(counter++); // 0 값이 출력되고 counter의 값이 1 증가한다(후증가)
console.log(counter); // 1

console.log(++counter); // 2 값이 출력되기 전에 1 증가(선증가)
